...
function createReactDemoConfig() {
  ...
  "stack": ["React", "Vite", "Tailwind CSS", "Cloudflare Workers"],
  "status": "draft",
...
`;
  ...
  const mainFile = `import { StrictMode } from "react";
    ...
    <main className="min-h-screen bg-[linear-gradient(180deg,_#f5f8ff_0%,_#eef7f3_100%)] text-slate-900">
      <section className="mx-auto flex min-h-screen w-full max-w-5xl flex-col justify-center px-6 py-16 md:px-10">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
          This starter was generated with the react template, using React,
          Vite, Tailwind CSS, and Cloudflare Workers deployment.
        </p>
      </section>
    </main>
  );
